  ...
  return (
    ...
    <>
        <div className="flex flex-col justify-center">
            ...
            <div className="flex items-center w-[1462px] h-[720px]" >
                <div className="h-[439px] w-[632px] flex flex-col gap-[27px]">
                    <div className='flex items-center'><hr className='w-[72px] border-[#FBD784]' /> <span className="mx-[32px] font-bold text-[18px] text-[#FBD784]">GET STARTED</span></div>
                ...
                <div className="w-[566px] h-[720px] ml-[50px]">
                    <img className="w-full h-auto" src="/01.png" alt="" />
                </div>
            </div>

            <div className="flex items-center justify-between w-[1462px] h-[720px] mt-[200px] gap-x-10" >
